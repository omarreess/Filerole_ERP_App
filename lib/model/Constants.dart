...
final clrGrey = Color(int.parse('#2b2a2a'.replaceAll('#', '0xff')));
...
final clrGreen3 = Color(int.parse('#3db37d'.replaceAll('#', '0xff')));
final clrGreen4 = Color(int.parse('#81ebba'.replaceAll('#', '0xff')));
final clrGreen5 = Color(int.parse('#95ab91'.replaceAll('#', '0xff')));

final gradient = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [
      Color(int.parse('#554474'.replaceAll('#', '0xff'))),
      Color(int.parse('#8a417a'.replaceAll('#', '0xff'))),
      Color(int.parse('#c05b7a'.replaceAll('#', '0xff'))),
      Color(int.parse('#E07264'.replaceAll('#', '0xff'))),
      Color(int.parse('#e78178'.replaceAll('#', '0xff')))
    ]);
final gradientSaved = LinearGradient(
    begin: Alignment.topLeft,
    end: Alignment.bottomRight,
    colors: [
      Color(int.parse('#554474'.replaceAll('#', '0xff'))),
