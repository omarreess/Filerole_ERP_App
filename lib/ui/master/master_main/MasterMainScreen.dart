        ...
        body: NestedScrollView(
          ...
          headerSliverBuilder: (BuildContext context, bool innerBoxIsScrolled) {
            ...
            return <Widget>[
              ...
              expandedHeight: 170,
                   collapsedHeight: 120,
                   automaticallyImplyLeading : false , // means not to back btn even it's avalible
                  centerTitle: true,
                  ...
                  bottom:PreferredSize(child: tabBarWidet(), preferredSize: Size.fromHeight(0.0),),
    ...
    child: Container(
      ...
      child: TabBar(
        ...
        tabs: [
          ...
          Tab( child: Text(S.of(context).master_label_payments.toUpperCase() , style: TextStyle(fontSize: 14),),),
          Tab( child: Text(S.of(context).master_label_subscriptions.toUpperCase() , style: TextStyle(fontSize: 14),),),
          Tab( child: Text(S.of(context).master_label_payment_method.toUpperCase() , style: TextStyle(fontSize: 14),),),
          Tab( child: Text( S.of(context).master_label_profile.toUpperCase() , style: TextStyle(fontSize: 14),),),
...
controller: tabController,
          ...
          //  mainAxisAlignment: MainAxisAlignment.spaceEvenly,
           children: [
            ...
            'https://instagram.fcai21-2.fna.fbcdn.net/v/t51.2885-15/e15/s320x320/11257032_692162207576745_1286537254_n.jpg?tp=1&_nc_ht=instagram.fcai21-2.fna.fbcdn.net&_nc_cat=109&_nc_ohc=TNm79m_HHyIAX-GRepl&oh=e6f61ba9f928ee4e85f776c74958f16f&oe=607A40CD',
             ...
             Text("Mohamed Ayman" , style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold,fontSize: 22,height: 1),) ,

             //drawer navigators
             Divider (height: 60,color: Colors.transparent,),
             drawerItemNavigator(icon: Icons.table_chart_outlined , label: S.of(context).master_label_payments,ctx: ctx ,index: 0 ),
             Divider (height: 16,color: Colors.transparent,),

             drawerItemNavigator(icon: Icons.subscriptions_outlined , label: S.of(context).master_label_subscriptions,ctx: ctx , index: 1),
             Divider (height: 16,color: Colors.transparent,),

             drawerItemNavigator(icon: Icons.credit_card , label: S.of(context).master_label_payment_method,ctx: ctx , index: 2),
             Divider (height: 16,color: Colors.transparent,),

             drawerItemNavigator(icon: Icons.account_circle_outlined , label: S.of(context).master_label_profile,ctx: ctx , index: 3),
             Divider (height: 26,color: Colors.transparent,),

             //Change language
             drawerItemNavigator(icon: Icons.translate , label: S.of(context).change_lang,ctx: ctx , index: 4),
             ...
             FlatButton(
              ...
              child: Text('English' , style: TextStyle(color: Colors.black54),),
              onPressed: (){
                Provider.of<LanguageProvider>(context, listen: false).changeLang(AppLanguages.en.toShortString());
              },
              ...
              VerticalDivider(color: Colors.transparent, width: 20,),
              FlatButton(
                color:Colors.white70.withOpacity(0.3),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(19.0),
                ),
                child: Text('عربي',textAlign: TextAlign.center,style: TextStyle(height: 1 ,color: Colors.black54),),
                onPressed: (){
                  Provider.of<LanguageProvider>(context, listen: false).changeLang(AppLanguages.ar.toShortString());
                      ...
                      FutureBuilder(
                        future: getVersionNumberUtill(),
                         builder: (context, AsyncSnapshot<String> snapshot) {
                          return Text("v${snapshot.data}" , style: TextStyle(color: Colors.white,fontSize: 15,height: 1),);
                        }
                      ) ,
                    ],
                  )),
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
              ...
              Icon(icon,color: Colors.white ,size: (index<4)?26:22,),

            VerticalDivider (width: 15,color: Colors.transparent,),

            Text(label ,style: TextStyle(color: Colors.white,fontWeight: FontWeight.w400, fontSize:(index<4)? 22:19.2)),
          ],),
      ),
    );
  }
  void logoutUser(){
    ...
    authState .graphQLClientRequest(
