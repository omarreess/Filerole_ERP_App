...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:  AppBar(title: Text('Login',style: TextStyle(fontSize: 20,color:Colors.white),),
        centerTitle: true,
      ...
      child: FocusScope(
        ...
        child: Column(
          ...
          children: [
            ...
            Divider(height:9 , color: Colors.transparent,),
            ...
            loginBtn() ,
            Divider(height:29 , color: Colors.transparent,),
            savedBtn()
          ...
          child: DropdownButton(
              ...
              items: [
                DropdownMenuItem(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.supervised_user_circle_outlined,color: Colors.white70,),
    ...
    //
      ...
      ,
        decoration: InputDecoration(
            icon: Icon(
              Icons.miscellaneous_services, color: Colors.white70
             ),
            //hintText: hintText,
        ...
        child: Container(
          ...
          child: FlatButton(
            ...
            child: Row(
              ...
              children: [
                Icon(Icons.bookmark_border_outlined , color: Colors.white,size: 22,),
                VerticalDivider(width:6 , color: Colors.transparent,),
                Text(
                  'Saved Accounts',

                  style: TextStyle( color: Colors.white,height: 1.6, fontSize: 15,fontWeight: FontWeight.normal),
                ),
              ],
            ),
          ),
      ...
      child: GestureDetector(
        ...
        child: Align (
          ...
          child: Text(
            ...
            style: TextStyle(fontSize: 13 , height: 1 , color: Colors.white70,fontWeight: FontWeight.normal),
          ),
        ),
        onTap:(){} ,),
    );
 ...
 void checkingNetworkRequest() async
  {
    ...
    loginAuth.graphQLClientRequest(

        queryDoc: loginAuth.loginQuery ,
        args:{
